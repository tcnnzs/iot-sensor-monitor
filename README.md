...
> 纯 Python 后端 + Web 前端 | 零硬件成本 | 电子信息/嵌入式/IoT 方向

---

## 📸 效果预览

启动后在浏览器打开 `http://localhost:8080`，将看到：
...
用 [ngrok](https://ngrok.com/) 生成一个临时公网链接，他人立马能访问：

```bash
ngrok http 8080
```

会得到一个 `https://xxxx.ngrok-free.app` 地址，发给他人就能打开。
